                            ...
                            <div class="form-row align-items-center">
                                <div class="col">
                                    <input type="search" wire:model="search" class="form-control mb-2"
                                        id="inlineFormInput" placeholder="alaeldin">
                    ...
                    <tbod>
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->username }} </td>
                                <td>{{ $user->email }} </td>
                                <td> <button wire:click="showEditModal({{ $user->id }})"class="btn btn-success">
                                        Edit </button>
                                <td> <button wire:click="deleteUser({{ $user->id }})"class="btn btn-danger">
                                        Delete </button>
                                </td>
                            </tr>
                        @empty
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="username" type="text"
                                            ...
                                            wire:model.defer="username" value="{{ old('username') }}">
